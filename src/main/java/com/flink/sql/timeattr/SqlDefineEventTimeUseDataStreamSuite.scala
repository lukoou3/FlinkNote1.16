 ...
 *
 * sql中定义事件时间的三种方式:
 *    https://nightlies.apache.org/flink/flink-docs-release-1.14/docs/dev/table/concepts/time_attributes/#event-time
 ...
 */
class SqlDefineEventTimeUseDataStreamSuite extends FlinkBaseSuite {
